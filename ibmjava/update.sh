...
osver="ubuntu alpine rhel ubi ubi-min ubi-micro"

# sha256sum for the various versions, packages and arches
# Version 8 sums [DO NO EDIT THIS LINE]
declare -A jre_8_sums=(
	[version]="8.0.8.65"
	[i386]="e9891c614f86c7446daafee29c46aa2177bff526d2395009f85b356c3195c047"
	[ppc64le]="9fad050b730cf070b341e5f7b5353c6cdd0a5a6f2d2b150678bfdff1f94f2637"
	[s390x]="c844b329e2161a7d0c5810b30085b5deeec28b911844220cb3b930f860b10884"
	[x86_64]="f848631ac7f7e61aa26d1e648bc7a96e97da64c33cbc4f76627ea3b367c9a085"
)

declare -A sdk_8_sums=(
	[version]="8.0.8.65"
	[i386]="5d1322ebecb36620fa55aeb05074b25530a2b65d6a7406876bbceb4b714e138b"
	[ppc64le]="731c2693424a66054fcc45624c411461ea8a62efd898a90f508bdbd20c0b6125"
	[s390x]="8a1cfafb51e8cf4753df40fb9906d3571ae086ed33b1bbcf807c416beac37521"
	[x86_64]="0978a87ce0b78bf6530fe5b9bd9fb737ff04ecc8dae1c849cb1c42908b1095a8"
)

declare -A sfj_8_sums=(
	[version]="8.0.8.65"
	[i386]="f38fe9deb52ecacaff7b76ba641067ec8b1fa5f1dc7760548cfb3ef8e92900a0"
	[ppc64le]="e85af7337f10d424e2660093dc3fc9d04e8c7e018eaa353a49e4dfa6902dd31d"
	[s390x]="bd360b8ccf462c9537dd214c9cc5920b93145b44fe05d3b49e214d01d79cfb5c"
	[x86_64]="a21f423374e941588c9d22e69cc011821558d044ba6a30c27eeb333535ed30be"
)
...
# Print the supported UBI Micro OS (builder stage uses ubi-minimal)
print_ubi-micro_os() {
	cat >> $1 <<-EOI
...
# Select the ubi-micro OS packages (two RUN blocks)
# Block 1: install build tools (curl, gzip, tar) into builder itself
# Block 2: install openssl and ca-certificates into /mnt/rootfs (separate root filesystem)
print_ubi-micro_pkg() {
	cat >> $1 <<'EOI'
...
print_env() {
	...
	if [ "${os}" == "ubi-min" -o "${os}" == "ubi" -o "${os}" == "ubi-micro" ]; then
        cat >> $1 <<-EOI
...
EOI
	...
	# ubi-micro uses curl instead of wget
...
# Print the main RUN command that installs Java on ubi-micro.
...
# Print the final stage for ubi-micro
# Uses /mnt/rootfs (pre-populated with openssl/ca-certs) instead of individual COPY lines
...
generate_ubi-micro() {
	...
	generate_java ${file};
	print_ubi-micro_final_stage ${file};
	print_java_env ${file};
	print_user ${file};
	echo "done"
}
